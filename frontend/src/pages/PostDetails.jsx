...
function PostDetails() {
  ...
  return (
    <div className="p-4 mt-4 gap-4 h-screen rounded-md justify-items-center bg-cover bg-[url('/Zeethon-post.png')]">
      <h2 className="p-4 text-2xl rounded-md font-bold bg-green-600 border border-gray-500 w-full md:w-2/3">{post.title}</h2>
      <div className="p-4 mt-4 rounded-md bg-green-600 border border-gray-500 w-full md:w-2/3">
        <textarea 
